...
class PatientsFrame(BaseFrame):
    def __init__(self, master, managers, *args, **kwargs):
        ...
        Args:
            ...
            managers: Dict containing all managers (pm, dm, am, etc.)
        """
    ...
    def build(self):
        # Build header and separator using base class
        self.build_header()
        ...
        # Form frame with better spacing
    ...
    def add_patient(self):
        """Add new patient with validation and error handling."""
        def _operation():
    ...
    def load_patient(self):
        """Load and display specific patient details."""
        def _operation():
